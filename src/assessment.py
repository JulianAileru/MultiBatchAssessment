...
class Assessment(AssessmentInfo):
    ...
    def pca_plot(self,pca_hue,imputation_method='Minimum Value',normalization_method=None,x='PC1',y='PC2',include_blanks=False,blank_str='_B_'):
        ...
        if normalization_method == None:
            ...
            D_ = Assessment.TIC(D_,scale=True)
    ...
    def plot_signal_drift(self,batch_idx,signal_idx,include_all_batches=False):
        ...
        params = {"batch idx":batch_idx,
                  "signal idx": signal_idx,
    ...
    def pvca(self,explained_variance=.50,imputation_method='Minimum Value',normalization_method=None):
        var_comp = make_rfunc("""
                      function(model){
